...
instance Contravariant Predicate where
  (>$<) ::
    ...
    -> Predicate a
    -> Predicate b
  f >$< Predicate a = Predicate $ \b -> a . f $ b
...
instance Contravariant Comparison where
  (>$<) ::
    ...
    -> Comparison a
    -> Comparison b
  f >$< ca = Comparison $ \b1 b2 -> runComparison ca (f b1) (f b2)
...
instance Contravariant (SwappedArrow t) where
  (>$<) ::
    ...
    -> SwappedArrow x a
    -> SwappedArrow x b
  -- f >$< sa = SwappedArrow $ \b -> runSwappedArrow sa $ f b
  f >$< SwappedArrow fa = SwappedArrow $ \b -> fa . f $ b
